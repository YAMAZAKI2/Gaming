...
import Shadow from "../../.././public/images/shadow.jpg"
import Spirit from "../../.././public/images/spirit.jpg"
import Link from 'next/link'
import BattlefieldV from "./t/BattlefieldV.js"
const listing = () => {
  return (
    <>
    ...
    <>
      ...
      <div className={Styles.container}>
        <div className={Styles.item}>
          <Link href='/components/t/BattlefieldV'>

            <div className={Styles.image}>
              <Image src={battlefield} alt="BattlefieldV" width={500} height={300} />
        ...
        <div className={Styles.item}>
          ...
          <div className={Styles.image}>
              <Image src={Battlefield1} alt="Battlefield1" width={500} height={300} />
            <div className={Styles.overlay}>
              <h2>Battlefield 1</h2>
              <p>
        ...
        <div className={Styles.item}>
          <Link href='/components/t/Ti'>
          <div className={Styles.image}>
              <Image src={Tale} alt="A Tale of Plague Innocence" width={500} height={300} />
            <div className={Styles.overlay}>
        ...
        <div className={Styles.item}>
          ...
          <div className={Styles.image}>
            <Image src={Rise} alt="Rise of the tomb raider" width={500} height={300} />
            <div className={Styles.overlay}>
        ...
        <div className={Styles.item}>
          ...
          <div className={Styles.image}>
            <Image src={Shadow} alt="Shadow of the tomb raider" width={500} height={300} />
            <div className={Styles.overlay}>
        ...
        <div className={Styles.item}>
          ...
          <div className={Styles.image}>
            <Image src={Spirit} alt="Article 3" width={500} height={300} />
            <div className={Styles.overlay}>
