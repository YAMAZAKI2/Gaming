...
const Battlefield1 = () => {
 return (
  <>
   <main className={Styles.main}> <h1 className={Styles.name}>1.Battlefield V</h1>
    ...
    <div className={Styles.p}>
     <p>Ah! The Battlefield V, where we get to know the World War 1 history lessons, and unknown stories. From firing your trusty rifle and dodging grenades and tank attacks makes the adrenaline goes on. The next, you're rushing through the air in a biplane, raining down bombs on off guard foes.
      <p>It's chaotic, it's intense, and it's oh-so-satisfying. But between all these action, bug sometimes  stab out of nowhere, which makes the whole joy down to some percentage.</p>
     ...
     <div className={Styles.youtube}>
      <iframe width="960" height="560" src="https://www.youtube.com/embed/zuNyi9YAtzg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
     </div>
     <br>
     </br>
     <br>
